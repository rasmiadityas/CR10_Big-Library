        ...
        <fieldset>
            ...
            <form action="actions/a_create.php" method= "post" enctype="multipart/form-data">
                <table class='table'>
                    ...
                    <tr>
                        <th>Publisher</th>
                        <td><input class='form-control' type="text" name="pubName"  placeholder="Publisher Name" 
						<?php
						if ($pubget==1) {
						echo "value='$pubName'";	
						}
                    ...
                    <tr>
                        ...
                        <td><input class='form-control' type="text" name="pubAddress"  placeholder="Publisher Address" 
						<?php
						if ($pubget==1) {
                    ...
                    <tr>
                        ...
                        <td><input class='form-control' type="text" name="pubSize"  placeholder="Small, Medium, Big" 
						<?php
						if ($pubget==1) {
						echo "value='$pubSize'";	
						}
